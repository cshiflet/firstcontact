...
//   Ctrl+1..9                 switch to the Nth signed-in account
//   Shift+L                   toggle link display (label vs label+URL)
//   ?          show this list
...
signals:
    ...
    // Ctrl+1 through Ctrl+9 — switch to the Nth account in the
    // toolbar account menu (1-indexed). MainWindow indexes into
